...
TARGET_DIR="${1:-}"
MARKER_START="# >>> agent-instructions-ruby-gem"
MARKER_END="# <<< agent-instructions-ruby-gem"
...
AGENT_INSTRUCTIONS="Read and follow agent/master-instructions.md as the primary instruction set for Ruby gem development.

## Workflow
- Plan first: 'plan gem for TICKET-ID'
...
- agent/workflow/implementation.md - Ruby gem coding conventions
...
1) Choose your workflow:
   ...
   - Start planning: "plan gem for TICKET-ID"
...
2) Planning workflow:
   - Command: "plan gem for TICKET-ID"
