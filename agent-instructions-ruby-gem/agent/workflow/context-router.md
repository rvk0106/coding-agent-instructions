...
LOAD IF class is part of public API:
...
SKIP:
  ...
  - infrastructure/environment.md (unless Ruby version affected)
```
...
LOAD IF public API changes:
  - features/_CONVENTIONS.md            → spec patterns
