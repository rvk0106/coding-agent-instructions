...
|-------------|--------|:-------------------:|
| Ruby version support | `infrastructure/environment.md` | Yes |
| Added/removed gem dependency | `infrastructure/dependencies.md` | Yes |
...
| Public API methods/signatures | `architecture/public-api.md` | Yes |
...
| Call flow, middleware | `architecture/data-flow.md` | Yes |
...
[PROJ-456] Dropped Ruby 2.7 support
```
