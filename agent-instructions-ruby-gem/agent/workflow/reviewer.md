...
- **Conventions:** `workflow/implementation.md` — file locations, Ruby gem conventions, YARD docs, danger zones
...
| Public methods have YARD docs | | @param, @return, @example |
...
| Danger zones avoided or explicitly called out | | Public API, deps, gemspec, publishing |
| Verification commands pass | | RSpec, RuboCop, YARD |
...
- Public methods have YARD docs: [Pass/Fail] — [note]
