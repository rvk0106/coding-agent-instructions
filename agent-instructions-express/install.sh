...
AGENT_INSTRUCTIONS="Read and follow agent/master-instructions.md as the primary instruction set for Express.js development.
...
- agent/principles-and-standards.md - Express.js coding standards
