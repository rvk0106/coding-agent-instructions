...
## Express Phase Checks
- If touching routes --> confirm validation middleware applied and Supertest specs added
- If touching models --> confirm migrations created and tested (rollback works)
- If adding endpoints --> confirm route registration in router and Supertest specs
- If API changes --> confirm Swagger/API docs updated (if using swagger-jsdoc)
- If adding middleware --> confirm registered in correct order in app.js
- If touching auth --> confirm security middleware tested with unauthorized cases
