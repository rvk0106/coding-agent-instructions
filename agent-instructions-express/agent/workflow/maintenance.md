...
|-------------|--------|:-------------------:|
| Node.js version, env vars | `infrastructure/environment.md` | Yes |
| Added/removed npm package or service | `infrastructure/dependencies.md` | Yes |
...
| Request lifecycle, middleware | `architecture/data-flow.md` | Yes |
...
```
## Changelog
[PROJ-123] Added Redis for session caching
[PROJ-456] Migrated from Sequelize to Prisma
```
