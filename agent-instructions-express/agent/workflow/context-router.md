...
LOAD:
  ...
  - architecture/data-flow.md          --> request lifecycle, middleware chain
  - architecture/patterns.md           --> route/controller/service conventions
  - architecture/glossary.md           --> domain terms
  - features/_CONVENTIONS.md           --> test patterns, validation patterns
...
LOAD:
  ...
  - architecture/data-flow.md          --> auth/middleware pipeline
  - architecture/glossary.md           --> role definitions
  - architecture/patterns.md           --> middleware conventions
...
LOAD IF writing tests:
  - features/_CONVENTIONS.md            --> test patterns, Supertest examples
...
LOAD IF API changes:
  - features/_CONVENTIONS.md            --> Supertest patterns
