# Master Instructions -- Express.js API Agent
...
- `infrastructure/environment.md` --> Node.js/Express versions, env vars, TypeScript config
- `infrastructure/dependencies.md` --> npm packages, external services, APIs
- `infrastructure/tooling.md` --> linters, test commands, CI/CD
- `infrastructure/deployment.md` --> hosting, deploy process, Docker
- `infrastructure/security.md` --> helmet, CORS, rate limiting, JWT, input validation

**Architecture** (technical design)
- `architecture/system-design.md` --> components, data flows, project structure
- `architecture/database.md` --> schema, tables, ORM/ODM, migrations
- `architecture/api-design.md` --> endpoints, response shapes, versioning, Swagger
- `architecture/patterns.md` --> design patterns, conventions, quality checklist
- `architecture/error-handling.md` --> error middleware, HTTP codes, error classes
- `architecture/data-flow.md` --> request lifecycle, middleware chain, transactions
...
- `features/_CONVENTIONS.md` --> Supertest, validation, and test patterns
