...
|-------------|--------|:-------------------:|
| Python/Django version, env vars | `infrastructure/environment.md` | Yes |
| Added/removed package or service | `infrastructure/dependencies.md` | Yes |
| CI/CD, linter, test config | `infrastructure/tooling.md` | Yes |
| Deploy process, hosting | `infrastructure/deployment.md` | Yes |
| DB schema, models, indexes | `architecture/database.md` | Yes |
...
| Error handling patterns | `architecture/error-handling.md` | Yes |
...
```
## Changelog
[PROJ-123] Added Celery for background task processing
[PROJ-456] Migrated from SQLite to PostgreSQL
```
