# Execution
> Tags: execute, phase, implement, contract, django
...
## Django Phase Checks
- If touching views -> confirm serializer validation and permission classes applied
- If touching models -> confirm migrations generated and test data factories updated
- If adding endpoints -> confirm urls.py updated and test coverage added
- If API changes -> confirm DRF schema updated (if using drf-spectacular)
- If touching settings -> confirm no security regressions (`python manage.py check --deploy`)
