...
|------|-----------|---------|
| [e.g. Account] | [Top-level entity -- org, workspace, or user account] | [models, views, serializers] |
| [e.g. Resource] | [Primary domain object your API manages] | [models, services, API] |
| [e.g. Membership] | [Relationship between user and account/group] | [models, serializers] |
