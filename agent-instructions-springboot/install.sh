...
TARGET_DIR="${1:-}"
MARKER_START="# >>> agent-instructions-springboot"
MARKER_END="# <<< agent-instructions-springboot"
...
AGENT_INSTRUCTIONS="Read and follow agent/master-instructions.md as the primary instruction set for Spring Boot development.

## Workflow
- Plan first: 'plan api for TICKET-ID'
...
- agent/workflow/implementation.md - Spring Boot coding conventions
...
1) Choose your workflow:
   ...
   - Start planning: "plan api for TICKET-ID"
...
2) Planning workflow:
   - Command: "plan api for TICKET-ID"
...
3) Execution workflow:
   ...
   - Verify: ./mvnw clean verify && ./mvnw checkstyle:check
