...
LOAD:
  ...
  - features/_CONVENTIONS.md          --> test patterns, DTO conventions
...
```
LOAD:
  - architecture/database.md          --> schema, tables, JPA conventions, migration rules
  - architecture/patterns.md          --> entity conventions, package structure
...
LOAD:
  ...
  - architecture/data-flow.md         --> if flow/filter-related
...
```
LOAD:
  - architecture/data-flow.md         --> async flows, @Async, message queues
...
SKIP:
  - architecture/api-design.md (jobs don't serve API directly)
...
LOAD:
  ...
  - architecture/data-flow.md         --> auth/filter pipeline
  - architecture/glossary.md          --> role definitions
  - architecture/patterns.md          --> @PreAuthorize conventions
...
```
LOAD:
  - architecture/database.md          --> schema conventions, migration rules, JPA conventions
...
LOAD IF writing tests:
  - features/_CONVENTIONS.md           --> test patterns, MockMvc templates
...
LOAD IF API changes:
  - features/_CONVENTIONS.md           --> controller test patterns
