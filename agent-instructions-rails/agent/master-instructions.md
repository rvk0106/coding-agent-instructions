# Master Instructions — Rails Full-Stack Agent
...
- JavaScript/Stimulus controller changes affecting multiple pages
...
- `infrastructure/environment.md` -> runtime, versions, DB, env vars, asset pipeline
...
- `infrastructure/security.md` -> auth, CSRF, XSS, query scoping, headers, rate limiting

**Architecture** (technical design)
- `architecture/system-design.md` -> components, data flows, stack
- `architecture/database.md` -> schema, tables, relationships
- `architecture/views.md` -> layouts, partials, helpers, Turbo/Hotwire, Stimulus
- `architecture/routing.md` -> routes, URL design, named paths, constraints
- `architecture/patterns.md` -> design patterns, conventions, quality checklist
- `architecture/error-handling.md` -> flash messages, error pages, exception mapping
- `architecture/data-flow.md` -> request lifecycle, Turbo frames/streams, transactions
...
- `features/_CONVENTIONS.md` -> view, form, query, and test patterns
