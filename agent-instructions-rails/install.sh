...
AGENT_INSTRUCTIONS="Read and follow agent/master-instructions.md as the primary instruction set for Rails full-stack development.
...
- agent/architecture/views.md - View layer conventions (Turbo/Stimulus)
