...
TARGET_DIR="${1:-}"
MARKER_START="# >>> agent-instructions-java-lib"
MARKER_END="# <<< agent-instructions-java-lib"
...
AGENT_INSTRUCTIONS="Read and follow agent/master-instructions.md as the primary instruction set for Java library development.
...
- agent/workflow/implementation.md - Java library coding conventions
