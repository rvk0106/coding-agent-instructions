...
|-------------|--------|:-------------------:|
| Java version support | `infrastructure/environment.md` | Yes |
...
| Package structure, components | `architecture/system-design.md` | Yes |
| Public API classes/methods | `architecture/public-api.md` | Yes |
...
| Call flow, thread safety | `architecture/data-flow.md` | Yes |
...
```
## Changelog
[PROJ-123] Added connection pooling with configurable limits
[PROJ-456] Dropped Java 11 support
```
