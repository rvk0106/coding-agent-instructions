...
## Java Library Phase Checks
- If touching public API: confirm Javadoc with @param/@return/@throws/@since and backward compatibility
- If adding classes: confirm JUnit 5 coverage for all public methods
- If changing exceptions: confirm exception hierarchy consistency
- If modifying configuration: confirm defaults, validation, and builder pattern
- If adding dependencies: confirm pom.xml/build.gradle updated and justified
