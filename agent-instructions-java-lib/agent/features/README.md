...
Living documentation of how each feature/capability works. Agents read these to understand existing behavior before planning or implementing changes.
...
├── connection-pool.md   (how connection pooling works)
└── ...
```
