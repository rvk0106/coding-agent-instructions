...
LOAD IF function has external calls:
...
LOAD IF module is part of public API:
  - architecture/public-api.md        → exports, type definitions
...
SKIP:
  ...
  - infrastructure/environment.md (unless Node version affected)
```

### Error Handling Change
```
LOAD:
  - architecture/error-handling.md    → CRITICAL: error hierarchy, codes, patterns
...
LOAD IF writing tests:
  - features/_CONVENTIONS.md            → test patterns, mock patterns
