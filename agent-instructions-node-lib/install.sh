...
## Technical Notes
- Package exports changes needed
...
- agent/workflow/implementation.md - Node.js library coding conventions
...
Agent instruction categories:
- agent/architecture/ - system design, public API, patterns, errors, data flow
- agent/infrastructure/ - environment, dependencies, tooling, publishing, security
- agent/workflow/ - planning, execution, testing, maintenance, ticket access
- agent/features/ - living docs for each feature
