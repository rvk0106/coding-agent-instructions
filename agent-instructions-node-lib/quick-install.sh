#!/usr/bin/env bash
# Quick install script for agent-instructions-node-lib
# Usage: curl -fsSL https://raw.githubusercontent.com/rvk0106/coding-agent-instructions/main/agent-instructions-node-lib/quick-install.sh | bash
# Or with custom directory: curl ... | bash -s /path/to/node/project

set -euo pipefail

REPO_URL="https://github.com/rvk0106/coding-agent-instructions"
FRAMEWORK_DIR="agent-instructions-node-lib"
BRANCH="main"
TEMP_DIR=$(mktemp -d)
TARGET_DIR="${1:-.}"
...
echo "🚀 Installing agent-instructions-node-lib..."
...
# Check if it looks like a Node.js library project
